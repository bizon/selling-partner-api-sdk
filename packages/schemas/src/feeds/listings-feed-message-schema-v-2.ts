...
export const listingsFeedMessageSchemaV2 = {
  $comment:
    'JSON Schema describing the document format for JSON Selling Partner Listings Message (v2).',
...
export type ListingsFeedMessageSchemaV2 = FromSchema<typeof listingsFeedMessageSchemaV2>
