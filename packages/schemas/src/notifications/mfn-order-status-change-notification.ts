...
export const mfnOrderStatusChangeNotification = {
  ...
  examples: [
    {
      ...
      Payload: {
        MFNOrderStatusChangeNotification: {
          ...
          PurchaseDate: 1_595_882_000_633,
  ...
  properties: {
    ...
    NotificationType: {
      ...
      description: 'An explanation about the purpose of this instance.',
      default: '',
      examples: ['MFN_ORDER_STATUS_CHANGE'],
    },
    PayloadVersion: {
    ...
    Payload: {
      ...
      required: ['MFNOrderStatusChangeNotification'],
      properties: {
        MFNOrderStatusChangeNotification: {
          ...
          properties: {
            ...
            SupplySourceId: {
              ...
              default: '',
              examples: ['55448834-0d79-5155-75c4-8529543a7c31'],
            },
            OrderItemId: {
...
export type MfnOrderStatusChangeNotification = FromSchema<typeof mfnOrderStatusChangeNotification>
