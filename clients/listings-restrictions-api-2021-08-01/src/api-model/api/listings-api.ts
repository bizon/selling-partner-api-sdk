...
export const ListingsApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async getListingsRestrictions(asin: string, sellerId: string, marketplaceIds: Array<string>, conditionType?: GetListingsRestrictionsConditionTypeEnum, reasonLocale?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestrictionList>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['ListingsApi.getListingsRestrictions']?.[localVarOperationServerIndex]?.url;
...
export const ListingsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getListingsRestrictions(requestParameters: ListingsApiGetListingsRestrictionsRequest, options?: RawAxiosRequestConfig): AxiosPromise<RestrictionList> {
...
export class ListingsApi extends BaseAPI {
     ...
     */
    public getListingsRestrictions(requestParameters: ListingsApiGetListingsRestrictionsRequest, options?: RawAxiosRequestConfig) {
