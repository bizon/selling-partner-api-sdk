...
// @ts-ignore
import type { ListingsItemDraftRelatedItem } from './listings-item-draft-related-item.js';

/**
 * Relationship details for a draft listings item.
 */
export interface ListingsItemDraftRelationship {
    /**
     * The type of relationship.
     */
    'type': ListingsItemDraftRelationshipTypeEnum;
    /**
     * Child items in the relationship.
     */
    'children'?: Array<ListingsItemDraftRelatedItem>;
}

export const ListingsItemDraftRelationshipTypeEnum = {
    Variation: 'VARIATION',
} as const;

export type ListingsItemDraftRelationshipTypeEnum = typeof ListingsItemDraftRelationshipTypeEnum[keyof typeof ListingsItemDraftRelationshipTypeEnum];
