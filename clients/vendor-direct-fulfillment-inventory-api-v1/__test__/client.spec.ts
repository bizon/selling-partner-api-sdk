...
import {VendorDirectFulfillmentInventoryApiClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new VendorDirectFulfillmentInventoryApiClient(configuration)
