...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public getPaymentMethods(requestParameters: DefaultApiGetPaymentMethodsRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof DefaultApi
     */
    public initiatePayout(requestParameters: DefaultApiInitiatePayoutRequest, options?: RawAxiosRequestConfig) {
