...
import {clientRateLimits, ProductFeesApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new ProductFeesApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(ProductFeesApiClient)
  })
})
