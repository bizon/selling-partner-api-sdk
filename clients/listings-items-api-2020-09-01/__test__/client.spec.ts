...
import {ListingsItemsApiClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new ListingsItemsApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(ListingsItemsApiClient)
  })
})
