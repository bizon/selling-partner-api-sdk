...
import {clientRateLimits, VendorDirectFulfillmentTransactionsApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new VendorDirectFulfillmentTransactionsApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(VendorDirectFulfillmentTransactionsApiClient)
  })
})
