...
import {clientRateLimits, VendorDirectFulfillmentShippingApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new VendorDirectFulfillmentShippingApiClient(configuration)
