...
import {FbaSmallAndLightApiClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new FbaSmallAndLightApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(FbaSmallAndLightApiClient)
  })
})
