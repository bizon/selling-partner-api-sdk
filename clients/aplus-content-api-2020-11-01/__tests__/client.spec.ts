...
import {AplusContentApiClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new AplusContentApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(AplusContentApiClient)
  })
})
