...
import {clientRateLimits, SolicitationsApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new SolicitationsApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(SolicitationsApiClient)
  })
})
