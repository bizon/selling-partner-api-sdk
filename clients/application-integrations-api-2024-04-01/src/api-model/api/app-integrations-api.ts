...
export class AppIntegrationsApi extends BaseAPI {
     ...
     */
    public createNotification(requestParameters: AppIntegrationsApiCreateNotificationRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof AppIntegrationsApi
     */
    public deleteNotifications(requestParameters: AppIntegrationsApiDeleteNotificationsRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof AppIntegrationsApi
     */
    public recordActionFeedback(requestParameters: AppIntegrationsApiRecordActionFeedbackRequest, options?: RawAxiosRequestConfig) {
