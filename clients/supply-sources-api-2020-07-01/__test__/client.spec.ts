...
import {clientRateLimits, SupplySourcesApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new SupplySourcesApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(SupplySourcesApiClient)
  })
})
