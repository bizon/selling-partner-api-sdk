...
import {ProductPricingApiClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new ProductPricingApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(ProductPricingApiClient)
  })
})
