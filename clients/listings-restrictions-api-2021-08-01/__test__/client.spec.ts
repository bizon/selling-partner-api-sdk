...
import {ListingsRestrictionsApiClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new ListingsRestrictionsApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(ListingsRestrictionsApiClient)
  })
})
