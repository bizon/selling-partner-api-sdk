...
import {ProductTypeDefinitionsApiClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new ProductTypeDefinitionsApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(ProductTypeDefinitionsApiClient)
  })
})
