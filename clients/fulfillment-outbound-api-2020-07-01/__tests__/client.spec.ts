...
import {clientRateLimits, FulfillmentOutboundApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new FulfillmentOutboundApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(FulfillmentOutboundApiClient)
  })
})
