...
import {ApplicationIntegrationsApiClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new ApplicationIntegrationsApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(ApplicationIntegrationsApiClient)
  })
})
