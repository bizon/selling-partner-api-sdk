...
import {ApplicationManagementApiClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new ApplicationManagementApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(ApplicationManagementApiClient)
  })
})
