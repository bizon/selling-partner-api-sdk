...
import {AmazonWarehousingAndDistributionClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new AmazonWarehousingAndDistributionClient(configuration)
    ...
    expect(client).toBeInstanceOf(AmazonWarehousingAndDistributionClient)
  })
})
