...
export type PropertiesPayloadPropertiesFulfillmentOrderStatusNotificationPropertiesFulfillmentShipmentPropertiesFulfillmentShipmentPackagesPropertiesFulfillmentShipmentPackageItem =
  TheFirstAnyOfSchema
/**
 * An explanation about the purpose of this instance.
 */
