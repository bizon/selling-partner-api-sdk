...
import {clientRateLimits, ShipmentInvoicingApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new ShipmentInvoicingApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(ShipmentInvoicingApiClient)
  })
})
