...
import {clientRateLimits, ReplenishmentApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new ReplenishmentApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(ReplenishmentApiClient)
  })
})
