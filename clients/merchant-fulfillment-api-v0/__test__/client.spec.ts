...
import {MerchantFulfillmentApiClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new MerchantFulfillmentApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(MerchantFulfillmentApiClient)
  })
})
