...
import {clientRateLimits, FbaInventoryApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new FbaInventoryApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(FbaInventoryApiClient)
  })
})
