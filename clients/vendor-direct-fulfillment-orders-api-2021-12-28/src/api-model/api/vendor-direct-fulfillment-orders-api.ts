...
// @ts-ignore
import type { OrderList } from '../models/index.js';
// @ts-ignore
import type { SubmitAcknowledgementRequest } from '../models/index.js';
// @ts-ignore
import type { TransactionId } from '../models/index.js';
/**
...
export const VendorDirectFulfillmentOrdersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getOrders: async (createdAfter: string, createdBefore: string, shipFromPartyId?: string, status?: GetOrdersStatusEnum, limit?: number, sortOrder?: GetOrdersSortOrderEnum, nextToken?: string, includeDetails?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarHeaderParameter['Accept'] = 'application/json,pagination,orders';
...
export const VendorDirectFulfillmentOrdersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getOrder(purchaseOrderNumber: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Order>> {
         ...
         * @throws {RequiredError}
         */
        async getOrders(createdAfter: string, createdBefore: string, shipFromPartyId?: string, status?: GetOrdersStatusEnum, limit?: number, sortOrder?: GetOrdersSortOrderEnum, nextToken?: string, includeDetails?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrderList>> {
         ...
         * @throws {RequiredError}
         */
        async submitAcknowledgement(body: SubmitAcknowledgementRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransactionId>> {
...
export const VendorDirectFulfillmentOrdersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getOrder(requestParameters: VendorDirectFulfillmentOrdersApiGetOrderRequest, options?: RawAxiosRequestConfig): AxiosPromise<Order> {
         ...
         * @throws {RequiredError}
         */
        getOrders(requestParameters: VendorDirectFulfillmentOrdersApiGetOrdersRequest, options?: RawAxiosRequestConfig): AxiosPromise<OrderList> {
         ...
         * @throws {RequiredError}
         */
        submitAcknowledgement(requestParameters: VendorDirectFulfillmentOrdersApiSubmitAcknowledgementRequest, options?: RawAxiosRequestConfig): AxiosPromise<TransactionId> {
