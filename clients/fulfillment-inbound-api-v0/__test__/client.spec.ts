...
import {clientRateLimits, FulfillmentInboundApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new FulfillmentInboundApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(FulfillmentInboundApiClient)
  })
})
