...
import {clientRateLimits, DataKioskApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new DataKioskApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(DataKioskApiClient)
  })
})
