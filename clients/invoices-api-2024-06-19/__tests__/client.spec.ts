...
import {clientRateLimits, InvoicesApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new InvoicesApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(InvoicesApiClient)
  })
})
