...
import {VendorOrdersApiClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new VendorOrdersApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(VendorOrdersApiClient)
  })
})
