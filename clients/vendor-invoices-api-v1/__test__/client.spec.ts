...
import {VendorInvoicesApiClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new VendorInvoicesApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(VendorInvoicesApiClient)
  })
})
