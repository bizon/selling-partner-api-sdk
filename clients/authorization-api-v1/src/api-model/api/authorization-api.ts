...
export const AuthorizationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAuthorizationCode(requestParameters: AuthorizationApiGetAuthorizationCodeRequest, options?: AxiosRequestConfig): AxiosPromise<GetAuthorizationCodeResponse> {
            return localVarFp.getAuthorizationCode(requestParameters.sellingPartnerId, requestParameters.developerId, requestParameters.mwsAuthToken, options).then((request) => request(axios, basePath));
        },
    };
};
