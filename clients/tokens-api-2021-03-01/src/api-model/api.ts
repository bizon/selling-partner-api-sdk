...
export class TokensApi extends BaseAPI {
     ...
     * @memberof TokensApi
     */
    public createRestrictedDataToken(body: CreateRestrictedDataTokenRequest, options?: any) {
        return TokensApiFp(this.configuration).createRestrictedDataToken(body, options).then((request) => request(this.axios, this.basePath));
    }
}
