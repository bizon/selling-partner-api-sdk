...
import {clientRateLimits, FbaInboundEligibilityApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new FbaInboundEligibilityApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(FbaInboundEligibilityApiClient)
  })
})
