 ...
 */
export interface ListingsItemDraftRelatedItem {
    /**
     * A selling partner-provided identifier for the related item.
     */
    'sku': string;
    /**
     * JSON object containing structured attribute data for the related item.
     */
