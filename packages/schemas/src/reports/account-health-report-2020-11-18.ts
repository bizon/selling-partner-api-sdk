...
export const accountHealthReport20201118 = {
  ...
  definitions: {
    DefectsCount: {
      type: 'integer',
      description:
        'The number of defects within a given reporting date range for 1 requested marketplace.',
      examples: [27_833],
    },
    OrderCount: {
      type: 'integer',
    ...
    Rate: {
      type: 'number',
      description:
        'Performance metric rate in percentage within a given reporting date range for 1 requested marketplace.',
      examples: [0.005],
    },
    ReportingDateRange: {
...
export type AccountHealthReport20201118 = FromSchema<typeof accountHealthReport20201118>
