...
// @ts-ignore
import type { ListingsItemDraftRelationship } from './listings-item-draft-relationship.js';

/**
 * Variation relationships for a draft listings item, grouped by Amazon store.
 */
export interface ListingsItemDraftRelationshipsByMarketplace {
    /**
     * Amazon store identifier.
     */
    'marketplaceId': string;
    /**
     * Relationships for the draft listings item.
     */
    'relationships': Array<ListingsItemDraftRelationship>;
}
