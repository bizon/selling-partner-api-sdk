...
> **Note:** Sandbox-only operations, unavailable in production: `createInventoryItem`, `deleteInventoryItem`, `addInventory`. Refer to the [Selling Partner API sandbox](https://developer-docs.amazon/sp-api/docs/sp-api-sandbox) documentation for more information.
...
Also, see the [generated documentation](https://bizon.github.io/selling-partner-api-sdk/modules/_sp-api-sdk_fba-inventory-api-v1.html) for this API client.
