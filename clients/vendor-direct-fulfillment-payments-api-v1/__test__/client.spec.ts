...
import {VendorDirectFulfillmentPaymentsApiClient, clientRateLimits} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new VendorDirectFulfillmentPaymentsApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(VendorDirectFulfillmentPaymentsApiClient)
  })
})
