...
export interface VarianceReason {
     ...
     */
    'varianceType': VarianceReasonVarianceTypeEnum;
    /**
     ...
     */
    'defectTypes'?: Array<string>;
}

export const VarianceReasonVarianceTypeEnum = {
    Pqv: 'PQV',
    Ppv: 'PPV',
    Other: 'OTHER',
} as const;

export type VarianceReasonVarianceTypeEnum = typeof VarianceReasonVarianceTypeEnum[keyof typeof VarianceReasonVarianceTypeEnum];
