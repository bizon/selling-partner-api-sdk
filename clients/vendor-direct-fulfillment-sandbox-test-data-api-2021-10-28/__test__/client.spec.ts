...
import {clientRateLimits, VendorDirectFulfillmentSandboxTestDataApiClient} from '../src/client'
...
describe('src/client', () => {
  it('should create a client instance', () => {
    ...
    const client = new VendorDirectFulfillmentSandboxTestDataApiClient(configuration)
    ...
    expect(client).toBeInstanceOf(VendorDirectFulfillmentSandboxTestDataApiClient)
  })
})
